...
{
    private const string IP = "192.168.43.105";
    private const int Port = 5555;

    private const int MessageSendFrequency = 50;
    ...
    private const int ResetShowLength = 4 * 72;
    ...
    void Update()
    {
        ...
        _path.transform.position = new Vector3(userPos.x, pathPos.y, userPos.z);
    ...
    private void UpdatePath(string data)
    {
        ...
        _path.transform.Rotate(Vector3.up, received);
