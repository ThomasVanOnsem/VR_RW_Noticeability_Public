...
def stringToCoordinate(elem):
    ...
    elem = elem[1:]
    coords = elem.split(',')
    if float(coords[0]) < -10.0 or float(coords[0]) > 10:
        print("TT")
...
if __name__ == '__main__':
    data_1 = parseLogFile('data/R1/192.168.43.151_17-05-2022_20-37-31.txt')
    data_2 = None
    try:
        data_2 = parseLogFile('data/R1/192.168.43.151_15-05-2022_16-12-04.txt')
    except:
        pass
    output = open('data/R1/stats.txt', 'w')
    if not data_2:
        printMovement(15, data_1['Receivedvirtpos'], {}, 100000)
        stats('User 1', data_1, output)
    if data_2:
        printMovement(15, data_1['Receivedvirtpos'], data_2['Receivedvirtpos'], 100000)
        stats('User 1', data_1, output)
